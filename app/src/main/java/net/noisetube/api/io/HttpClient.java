...
public abstract class HttpClient {
     ...
     * @throws Exception
     */
    public abstract void postRequest(String url, String body, String mimeType) throws Exception;

    public abstract HttpResponse postRequest(String url, List<NameValuePair> params) throws Exception;

    public abstract boolean sendPostRequest(String url, String body, String mimeType) throws Exception;

    public abstract boolean updateUserAvatar(String url, File file, String userKey) throws Exception;

    public abstract String uploadTrackFile(String url, File file, String userKey) throws Exception;

    public abstract ByteArrayOutputStream sendGetRequest(String url) throws Exception;
