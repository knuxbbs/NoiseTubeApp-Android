...
public interface NTCoordinates {
    ...
    public abstract double distanceTo(NTCoordinates otherCoordinates);

    public abstract boolean equals(NTCoordinates otherCoordinates);

    public abstract double azimuthTo(NTCoordinates toPosition);

    public abstract NTCoordinates copy();
