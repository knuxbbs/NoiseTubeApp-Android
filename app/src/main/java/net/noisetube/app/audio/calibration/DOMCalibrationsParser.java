...
public class DOMCalibrationsParser implements CalibrationsParser {
    ...
    public CalibrationsList parseList(InputStream is, int source) {
        ...
        try {
            lastChanged = null;
            parsedCalibrations = new ArrayList<Calibration>();
            ...
            log.error(e, "Error upon parsing Calibrations XML from source: " + Calibration.getSourceString(source));
            return null;
        } finally {
            try {
                is.close();
    ...
    public Calibration parseCalibration(String singleCalibrationAsXML, int source) {
        try {
            ...
            log.error(e, "Error upon parsing Calibration XML node from source: " + Calibration.getSourceString(source));
            return null;
        }
    }
